...
import kafka.metrics.ClientMetricsTestUtils.{createCMSubscription, createClientInstance, DefaultMetrics, DefaultPushIntervalMs, getClientInstance}
import ClientMetricsConfig1.ClientMatchingParams.{CLIENT_SOFTWARE_NAME, CLIENT_SOFTWARE_VERSION, CLIENT_SOURCE_ADDRESS}
import kafka.metrics.{ClientMetricsCache, ClientMetricsConfig1, ClientMetricsMetadata}
...
class ClientMetricsCacheTest {
  @AfterEach
  def cleanup(): Unit = {
    ClientMetricsConfig1.clearClientSubscriptions()
  ...
  def testClientMetricsSubscription(): Unit = {
    ...
    val client = ClientMetricsMetadata("testClient1", "clientId", "Java", "11.1.0.1", "", "")
    ...
    assertEquals(clientStateFromCache.getPushIntervalMs, DefaultPushIntervalMs)
  ...
  def testAddingMultipleSubscriptions(): Unit = {
    ...
    props.put(ClientMetricsConfig1.ClientMetrics.ClientMatchPattern, clientMatchPatterns.mkString(","))
    ...
    assertEquals(clientState.getPushIntervalMs, DefaultPushIntervalMs)
    ...
    props3.put(ClientMetricsConfig1.ClientMetrics.SubscriptionMetrics, metrics3)
    ...
    updatedProps.put(ClientMetricsConfig1.ClientMetrics.SubscriptionMetrics, updated_metrics)
...
//    props4.put(ClientMetricsConfig.ClientMetrics.DeleteSubscription, "true")
    ...
    assertNull(ClientMetricsConfig1.getClientSubscriptionInfo("cm_1"))
  ...
  def testMultipleSubscriptionsAndClients(): Unit = {
    ...
    props2.put(ClientMetricsConfig1.ClientMetrics.SubscriptionMetrics, metrics2)
    ...
    props3.put(ClientMetricsConfig1.ClientMetrics.SubscriptionMetrics, metrics3)
    props3.put(ClientMetricsConfig1.ClientMetrics.ClientMatchPattern, clientPatterns3.mkString(","))
    createCMSubscription("cm_3", props3)
    ...
    props4.put(ClientMetricsConfig1.ClientMetrics.ClientMatchPattern, clientPatterns4.mkString(","))
    props4.put(ClientMetricsConfig1.ClientMetrics.SubscriptionMetrics, metrics4)
    createCMSubscription("cm_4", props4)
    assertEquals(ClientMetricsConfig1.getSubscriptionsCount, 4)

    val client1 = createClientInstance(ClientMetricsMetadata("testClient1", "Id1", "Java", "11.1.0.1", "", ""))
    val client2 = createClientInstance(ClientMetricsMetadata("testClient2", "Id2", "Python", "8.2.1", "abcd", "0"))
    val client3 = createClientInstance(ClientMetricsMetadata("testClient3", "Id3", "C++", "12.1", "192.168.1.7", "9093"))
    val client4 = createClientInstance(ClientMetricsMetadata("testClient4", "Id4", "Java", "11.1", "1.2.3.4", "8080"))
    val client5 = createClientInstance(ClientMetricsMetadata("testClient2", "Id5", "Python", "8.2.1", "1.2.3.4", "0"))
  ...
  def testMultipleClientsAndSubscriptions(): Unit = {
    ...
    val client1 = createClientInstance(ClientMetricsMetadata("t1", "c1", "Java", "11.1.0.1", "", "")).getId
    val client2 = createClientInstance(ClientMetricsMetadata("t2", "c2", "Python", "8.2.1", "abcd", "0")).getId
    val client3 = createClientInstance(ClientMetricsMetadata("t3", "c3", "C++", "12.1", "192.168.1.7", "9093")).getId
    val client4 = createClientInstance(ClientMetricsMetadata("t4", "c4", "Java", "11.1", "1.2.3.4", "8080")).getId
    val client5 = createClientInstance(ClientMetricsMetadata("t5", "c5", "Python", "8.2.1", "1.2.3.4", "0")).getId
    assertEquals(ClientMetricsCache.getInstance.getSize, 5)
  ...
  def testCleanupTtlEntries(): Unit = {
    ...
    val client1 = createClientInstance(ClientMetricsMetadata("testClient1", "clientId1", "Java", "11.1.0.1", "", ""))
    val client2 = createClientInstance(ClientMetricsMetadata("testClient2", "clientId2", "Python", "8.2.1", "", ""))
    val client3 = createClientInstance(ClientMetricsMetadata("testClient3", "clientId3", "C++", "12.1", "", ""))
