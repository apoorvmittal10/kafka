...
import kafka.metrics.{ClientMetricsReceiverPlugin, ClientMetricsTestUtils}
...
class KafkaApisTest {
  ...
  def testGetTelemetrySubscriptions(): Unit = {
    ...
    when(clientMetricsManager.processGetTelemetrySubscriptionRequest(any[GetTelemetrySubscriptionsRequest](),
      any[Integer](), any[RequestContext](), any[Integer]())).thenReturn(new GetTelemetrySubscriptionsResponse(
      new GetTelemetrySubscriptionsResponseData()))

    // Register client metrics receiver plugin.
    ClientMetricsReceiverPlugin.instance.add(new ClientMetricsTestUtils.TestClientMetricsReceiver())
    metadataCache = MetadataCache.kRaftMetadataCache(brokerId)
  ...
  def testGetTelemetrySubscriptionsNoMetricsPlugin(): Unit = {
    ...
    ClientMetricsReceiverPlugin.instance().clear()
    metadataCache = MetadataCache.kRaftMetadataCache(brokerId)
    createKafkaApis(raftSupport = true).handle(request, RequestLocal.NoCaching)
  ...
  def testGetTelemetrySubscriptionsWithException(): Unit = {
    ...
    when(clientMetricsManager.processGetTelemetrySubscriptionRequest(any[GetTelemetrySubscriptionsRequest](),
      any[Integer](), any[RequestContext](), any[Integer]())).thenThrow(new RuntimeException("test"))
  ...
  def testPushTelemetry(): Unit = {
    ...
    when(clientMetricsManager.processPushTelemetryRequest(any[PushTelemetryRequest](),
      any[Integer](), any[RequestContext](), any[Integer]())).thenReturn(new PushTelemetryResponse(
      new PushTelemetryResponseData()))
