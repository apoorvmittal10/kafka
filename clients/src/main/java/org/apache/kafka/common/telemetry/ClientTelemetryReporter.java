...
import org.apache.kafka.common.telemetry.internals.ClientTelemetryMetricsEmitter;
import org.apache.kafka.common.telemetry.internals.ClientTelemetrySender;
import org.apache.kafka.common.telemetry.internals.Context;
import org.apache.kafka.common.telemetry.internals.KafkaClientProvider;
...
import org.apache.kafka.common.telemetry.internals.MetricNamingConvention;
import org.apache.kafka.common.telemetry.internals.MetricsCollector;
import org.apache.kafka.common.telemetry.internals.Provider;
...
//    initCollectors();
  ...
  public class DefaultClientTelemetrySender implements ClientTelemetrySender {
    ...
    private Optional<Builder<?>> createPushRequest(ClientTelemetrySubscription localSubscription) {
      ...
      try (ClientTelemetryMetricsEmitter emitter = new ClientTelemetryMetricsEmitter(localSubscription.selector(), ctx)) {
        emitter.init();
      ...
      AbstractRequest.Builder<?> requestBuilder = new PushTelemetryRequest.Builder(
          new PushTelemetryRequestData()
              ...
              .setMetrics(metricsData.get()), true);
