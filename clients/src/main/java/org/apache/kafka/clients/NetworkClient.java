...
public class NetworkClient implements KafkaClient {
    ...
    public List<ClientResponse> poll(long timeout, long now) {
        ...
        log.debug("[APM] - minimum timeout: {}", Utils.min(timeout, metadataTimeout, telemetryTimeout, defaultRequestTimeoutMs));
        try {
        ...
        for (NetworkReceive receive : this.selector.completedReceives()) {
            ...
            if (req.isInternalRequest && response instanceof MetadataResponse)
                ...
                handleApiVersionsResponse(responses, req, now, (ApiVersionsResponse) response);
                        ...
                        || response instanceof PushTelemetryResponse)) {
                if (response instanceof GetTelemetrySubscriptionsResponse) {
