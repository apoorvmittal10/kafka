...
//    initCollectors();
  ...
  public class DefaultClientTelemetrySender implements ClientTelemetrySender {
    ...
    private Optional<Builder<?>> createSubscriptionRequest(ClientTelemetrySubscription localSubscription) {
      ...
      AbstractRequest.Builder<?> requestBuilder = new GetTelemetrySubscriptionRequest.Builder(
          new GetTelemetrySubscriptionsRequestData().setClientInstanceId(clientInstanceId));
