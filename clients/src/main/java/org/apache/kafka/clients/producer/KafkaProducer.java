...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    KafkaProducer(ProducerConfig config,
        ...
        try {
            ...
            Optional<ClientTelemetryReporter> telemetryReporter = CommonClientConfigs.telemetryReporter(clientId, config);
            if (telemetryReporter.isPresent()) {
                this.clientTelemetryReporter = telemetryReporter.get();
                reporters.add(clientTelemetryReporter);
            } else {
